...
public class ApolloTest {
    ...
    public void tileToMove() {
        ...
        tileToMove = apollo.tileToMove(apollo.currentWorker.getIndexTile());
    ...
    public void tileToMove2() {
        ...
        assertEquals(2, apollo.tileToMove(apollo.currentWorker.getIndexTile()).size());
        ...
        assertEquals(0, apollo.tileToMove(apollo.currentWorker.getIndexTile()).size());
    }
    ...
    public void move() {
        apollo.selectWorker(player1.getWorkers().get(0));
        try {
            IndexTile oldPosition = apollo.currentWorker.getIndexTile();
    ...
    public void move2() {
        ...
        try {
            ...
            assertEquals(newTile.getCurrentWorker(), apollo.currentWorker);
        } catch (DomeAlreadyPresentException | AlreadyOccupiedException e) {
            e.printStackTrace();
        }
    }
